...
description: 'API sobre consulta, pago y reversión de bienes inmuebles.'
date: May 08 2022
---
...
```
[GET] http://ip.servidor:puerto/simafiws/consulta/inmuebles/{{clave}}
```
...
```js
var client = new RestClient("http://190.168.1.1:8080/simafiws/consulta/inmuebles/SEPU04-01-0585");
client.Timeout = -1;
...
```
[POST] http://ip.servidor:puerto/simafiws/pago/inmuebles
```
...
```js
var client = new RestClient("http://192.168.1.1:8080/simafiws/pago/inmuebles");
client.Timeout = -1;
...
```
[POST] http://ip.servidor:puerto/simafiws/reversion/inmuebles
```
...
```js
var client = new RestClient("http://192.168.1.1:8080/simafiws/reversion/inmuebles");
client.Timeout = -1;
var request = new RestRequest(Method.POST);
request.AddHeader("x-auth-id", "99");
request.AddHeader("x-auth-key", "8E9AC3E8B77C5B79161E5D1B2A7C0D06");
